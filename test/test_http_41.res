...
<hit>
 ...
 <count>1</count>
 <relevance>190683</relevance>
 <relevance_info>
field=title content=SAMPLES ANALYZED FOR PROSPECTORS IN THE NBMG (NMA ...;
the: w[1] += w(6) / (1+log2(1+lead_decay(0.000000) * length(5)));
the: tf[1] += w[1](6) / length(10) (0.600000);
relevance = 0;
idf[1] = log(((1 + total(23))/termoccur(1));
the: relevance += 100000 * tf[1](0.600000) * idf[1](3.178054) (190683);
score = relevance(190683);
 </relevance_info>
 <recid>content: title samples analyzed for prospectors in the nbmg nmal chemical laboratory author medium book</recid>
</hit>
<hit>
...
score = relevance(0);
 ...
 <recid>content: title reconnaissance surficial geologic map series author medium book</recid>
</hit>
<hit>
