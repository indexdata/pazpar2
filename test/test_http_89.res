...
computer: tf[1] += w[1](6) / length(3) (2.600000);
...
computer: tf[1] += w[1](3) / length(3) (4.433333);
field=subject content=Computer networks;
computer: w[1] += w(3) / (1+log2(1+lead_decay(0.000000) * length(0)));
computer: tf[1] += w[1](3) / length(2) (5.933333);
field=subject content=Computer Systems;
computer: w[1] += w(3) / (1+log2(1+lead_decay(0.000000) * length(0)));
computer: tf[1] += w[1](3) / length(2) (7.433333);
relevance = 0;
idf[1] = log(((1 + total(11))/termoccur(11));
computer: relevance += 100000 * tf[1](7.433333) * idf[1](0.087011) (64678);
score = relevance(64678);
 </relevance_info>
...
computer: tf[1] += w[1](6) / length(10) (2.600000);
...
computer: tf[1] += w[1](6) / length(7) (3.457143);
...
field=subject content=Internet (Computer network);
computer: w[1] += w(3) / (1+log2(1+lead_decay(0.000000) * length(1)));
computer: tf[1] += w[1](3) / length(3) (5.314286);
relevance = 0;
idf[1] = log(((1 + total(11))/termoccur(11));
computer: relevance += 100000 * tf[1](5.314286) * idf[1](0.087011) (46240);
score = relevance(46240);
 </relevance_info>
...
relevance = 0;
idf[1] = log(((1 + total(11))/termoccur(11));
computer: relevance += 100000 * tf[1](1.200000) * idf[1](0.087011) (10441);
score = relevance(10441);
 </relevance_info>
